...
FSAmpToolsPlotGenerator::FSAmpToolsPlotGenerator( const FitResults& results ) :
PlotGenerator( results )
{
  ...
  bookHistogram( kdltz, new Histogram2D( 60, 0.0, 9.0, 60, 0.0, 9.0, "dltz", "FSAmpTools Plot" ) );
}

void
FSAmpToolsPlotGenerator::projectEvent( Kinematics* kin ){
