...
complex< GDouble > wignerD_1( int l, int m, int n, 
...
complex< GDouble > wignerD_1( int l, int m, GDouble n, 
                           GDouble theta, GDouble phi ){
...
complex< GDouble > wignerDC_1( int l, int m, int n, 
                           GDouble theta, GDouble phi ){
...
complex< GDouble > wignerDC_1( int l, int m, GDouble n, 
                           GDouble theta, GDouble phi ){
...
complex< GDouble > wignerDC_1( GDouble l, GDouble m, GDouble n, 
                           GDouble theta, GDouble phi ){
...
complex< GDouble > wignerD( int l, int m, int n, 
			    GDouble cosTheta, GDouble phi1, GDouble phi2 ){
	
    double dtheta = acos( cosTheta ) * 180.0 / PI;
	
    GDouble dpart = wignerDSmall( l, m, n, dtheta );

    return complex< GDouble >( cos( -1.0*m*phi1 + -1.0*n*phi2 ) * dpart, 
			                                 sin( -1.0*m*phi1 + -1.0*n*phi2 ) * dpart );
	
}

complex< GDouble > wignerDC( int l, int m, int n, 
			    GDouble cosTheta, GDouble phi1, GDouble phi2 ){
	
    double dtheta = cosTheta;
