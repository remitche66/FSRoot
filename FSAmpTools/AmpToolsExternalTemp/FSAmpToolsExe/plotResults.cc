...
#include "FSAmpToolsPlot/FSAmpToolsPlotGenerator.h"
...
int main( int argc, char* argv[] ){
  ...
  FSAmpToolsPlotGenerator plotGenerator( results );
  ...
  for (unsigned int ivar  = 0; ivar  < FSAmpToolsPlotGenerator::kNumHists; ivar++){

             string histname =  "h";
    if (ivar == FSAmpToolsPlotGenerator::khm12)  histname += "m12";
    if (ivar == FSAmpToolsPlotGenerator::khm13)  histname += "m13";
    if (ivar == FSAmpToolsPlotGenerator::khm23)  histname += "m23";
    ...
    thist->SetTitle("IUAmpTools FSAmpTools Tutorial");
