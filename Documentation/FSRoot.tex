...
(4) There is usually a {\tt .rootrc} file in your home directory that \ROOT\ uses for initialization.  Add lines like these to {\tt .rootrc}, telling \ROOT\ the location of \FSR:
\begin{verbatim}
