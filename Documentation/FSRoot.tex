...
-- {\it {\tt v6.18} and after}: \FSR\ should work \\
-- {\it {\tt v5.34.09} up to {\tt v6.18}}: \FSR\ should work, but without some functionality (e.g. {\tt RDataFrame}) \\
-- {\it {\tt v5.34.08} and before}: \FSR\ may or may not work 
